<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderDetails.aspx.cs" Inherits="WebApplication1.OrderDetails"
    ...
    <head runat="server">
        ...
        <style>
            ...
            h2::before {
                content: "\f2e7";
                /* Mã Unicode của biểu tượng đồ ăn (tùy chỉnh theo nhu cầu) */
            ...
            .btn-action:active {
                ...
                /* Thêm hiệu ứng thu nhỏ khi click */
            }
        </style>
    </head>
    ...
    <body>
        <form id="form1" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="gridview-style" AutoGenerateColumns="False">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <asp:Button ID="btnAdd" runat="server" Text="+" CommandArgument='<%# Eval("ItemID") %>'
            ...
            <asp:Button ID="btnToggleOrder" runat="server" Text="YOUR ORDER" OnClick="btnToggleOrder_Click"
                CssClass="btn-toggle-order" />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <asp:Button ID="btnRemove" runat="server" Text="-" CommandArgument='<%# Eval("ItemID") %>'
            ...
            <asp:Button ID="btnCreateOrder" runat="server" Text="TẠO ĐƠN" OnClick="btnCreateOrder_Click"
                CssClass="btn-action" />
            <asp:Button ID="btnCancelOrder" runat="server" Text="HỦY ĐƠN" OnClick="btnCancelOrder_Click"
                CssClass="btn-action" />

            <asp:Button ID="btnViewInvoice" runat="server" Text="CHECK INVOICE" OnClick="btnViewInvoice_Click"
                CssClass="btn-toggle-order" />

            <asp:GridView ID="GridViewInvoice" runat="server" CssClass="gridview-style" Visible="false"
